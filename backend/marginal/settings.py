...
# Prototype only — do not use this key in production.
SECRET_KEY = "django-insecure-marginal-prototype-key-change-me"
DEBUG = True
ALLOWED_HOSTS = ["*"]
...
WSGI_APPLICATION = "marginal.wsgi.application"
